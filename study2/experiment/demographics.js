                ...
                elements: [
                    {
                        ...
                        choices: ["Feet", "Centimetres", "Prefer not to say"],
                        isRequired: true,
                        colCount: 0,
                    },
                    {
                        visibleIf: "{Height_Measurement} contains 'Feet'",
                        type: "text",
                        title: "What is your height (in feet)",
                        name: "Height_ft",
                        isRequired: true,
                        placeholder: "e.g., for 5 feet 6 inches write 5'6",
                    },
                    {
                        visibleIf: "{Height_Measurement} contains 'Centimetres'",
                        type: "text",
                    ...
                    },
                    {
                        ...
                        choices: ["Stone", "Kilograms", "Prefer not to say"],
                        isRequired: true,
                        colCount: 0,
                    },
                    {
                        visibleIf: "{Weight_Measurement} contains 'Stone'",
                        type: "text",
                        title: "What is your weight (in stone)",
                        name: "Weight_st",
                        isRequired: true,
                        placeholder: "e.g., for 13 stone 4 pounds write 13.04",
                    },
                    {
                        visibleIf: "{Weight_Measurement} contains 'Kilograms'",
                        type: "text",
