...
n <- parameters::n_factors(items, type = "FA", rotation = "oblimin", package = "psych")
plot(n)

fa <- parameters::factor_analysis(items, n = 11, rotation = "varimax", sort = TRUE, package = "psych")
plot(fa)
...
```{r}
fa2 <- parameters::factor_analysis(items,
  n = 11,rotation = "oblimin",package = "psych"
)
```
