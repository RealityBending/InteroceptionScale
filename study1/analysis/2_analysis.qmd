...
- optimal number of factors to extract 1, 13 (then 29, 101)

```{r}
n <- parameters::n_factors(items, type = "FA")
plot(n) 
```
...
# item_omega(items, n = 4, poly_cor = TRUE) # omega 
# model_parameters(mint_omg) |> display() #view loadings
# summary(mint_omg) |> display() # view reliability estimates
