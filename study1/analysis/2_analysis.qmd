...
```{r}
n <- parameters::n_factors(items, type = "FA", rotation = "oblimin",  package = c("psych"))
plot(n) 
```
...
fa <- parameters::factor_analysis(items, n = 1, rotation = "oblimin", scores = "tenBerge", sort = TRUE, cor = "poly")
plot(fa)
