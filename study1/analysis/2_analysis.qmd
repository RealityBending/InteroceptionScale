...
rbind(higher, select(lower, -ID)) |>
  ...
  select(-Cluster, -Max) |>
  # datawizard::data_rename(c(XC1 = "C01", XC2 = "C02")) |> 
  gt::gt() |>
  gt::tab_row_group(
    label = "Items",
  ...
  gt::cols_width(Label ~ gt::pct(30)) |>
  gt::gtsave("table1.html", inline_css = TRUE) # Save it and reload it otherwise formatting not ideal
```


<object type="text/html" data="table1.html" width="120%" height="1000"></object>
...
ggraph(layout) +
  ...
  scale_color_manual(values=c(
    "H1"="#90CAF9", "H2"="#C5E1A5", "H3"="#EF9A9A", 
    "L1"="#CE93D8", "L9"="#9FA8DA", "L13"="#90CAF9", "L18"="#81D4FA", "L3"="#80DEEA",
