...
Interoception Questionnaire (Mint) and \textbf{tested its relationship
with other measures}. In Study 1 (N=559), a comprehensive item pool
using a novel ``modality-by-context'' framework was generated and then
reduced using psychometric network analysis. In Study 2 (N=737),
\textbf{we further establish the structure of the Mint in an independent
sample}, and compare its predictive power against established
interoception questionnaires (MAIA-2, BPQ, IAS), and across a wide range
of clinical and cognitive outcomes. This rigorous process yielded a
33-item scale with a stable hierarchical structure comprising three
metaclusters (Interoceptive Deficit, Interoceptive Awareness,
...
\par{ }
\par{     \begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, opacityback=0, leftrule=.75mm, breakable, toprule=.15mm, left=2mm, arc=.35mm, rightrule=.15mm, colback=white]
...
facets.\footnote{\emph{{[}MASKED FOR REVIEW{]}}} Items were generated
through conversations between the researchers/authors of this paper.
Items were generated through conversations between the
reserachers/authors of these paper.
...
participants' responses to the Mint scale\^{}{[}The experiment can be
...
Noticing (Sati), Olfactory Contribution (Olfa), Respiroception (Resp),
...
{\caption{{Descriptive statistics and gender differences across MINT
clusters. For each cluster, mean scores and standard deviations are
reported separately by gender (excluding participants identifying as
``Other''), alongside independent-samples t-test results and
corresponding Cohen's d effect sizes. Statistical significance of group
differences is indicated using standard thresholds (* p \textless{} .05,
** p \textless{} .01, *** p \textless{} .001).}{\label{fig-seven}}}}

\begin{center}
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{../study2/analysis/figures/table3.png}
\end{center}
