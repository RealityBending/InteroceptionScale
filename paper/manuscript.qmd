...
For both studies, data analysis was carried out using R [4.4.3, @Rcoreteam], leveraging the *easystats* ecosystem [@ludecke2019insight; @ludecke2020extracting] and the *EGAnet* package [@christensen2021estimating]. The reproducible code and additional details are available at https://github.com/RealityBending/InteroceptionScale.
